...
//
// Copyright (c) 2026 Anton и участники проекта ВЕЧЕ.
// Свободное ПО под лицензией MIT: берите, изменяйте и используйте как угодно,
// в том числе в коммерческих проектах — достаточно сохранить это уведомление.
// Программа распространяется БЕЗ КАКИХ-ЛИБО ГАРАНТИЙ. Полный текст — в файле LICENSE.
